...
public class ExcelUtils {
    ...
    private Map<String, ExcelFormatEumn> formatInfo;
    ...
    public ExcelUtils(List list, List<ExcelHeaderInfo> excelHeaderInfos, Map<String, ExcelFormatEumn> formatInfo) {
        this.list = list;
        this.excelHeaderInfos = excelHeaderInfos;
     ...
     * @param workbook 工作簿
     */
    public void sendHttpResponse(HttpServletResponse response, HttpServletRequest request, String fileName, Workbook workbook) {
        try {
